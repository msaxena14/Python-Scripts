...
def update_template_version(template_id,source_version,description,image_id):
    launch_template_object = boto3.client('ec2')
    response  =  launch_template_object.create_launch_template_version(
        DryRun = False,
        LaunchTemplateId = template_id,
        SourceVersion = str(source_version),
        VersionDescription = description + ' patched_ami_rollout',
        LaunchTemplateData = {
            # 'KernelId': 'string',
    ...
    response_received = launch_template_object.modify_launch_template(
        DryRun=False,
        LaunchTemplateId=response['LaunchTemplateVersion']['LaunchTemplateId'],
